...
- read `MATRIXNEO23/scodinzolina-conntinuity/agent-exchanges/correspondence/2026-09-17-bootstrap-001.md` if available;
- read her own local state in `MATRIXNEO23/TESSA/agent-exchanges/`;
- append one Tessa turn to `MATRIXNEO23/TESSA/agent-exchanges/correspondence/2026-09-17-bootstrap-001.md`;
